...
namespace SharpCalc
{
    public static class EquationList
    {
        ...
        private static readonly Word Delta =
        ...
        private static Word QuadraticFormula = new Multiply(new Add(Negative.Create(QuadraticParameters.b), new FunctionCall(StaticData.sqrt, Delta)), new Number(1 / 2), new Power(QuadraticParameters.a, new Number(-1))); // -b + sqrt(delta) / 2a
        public static Word QuadraticEquation(Equator equator, Word a, Word b, Word c)
        {
